...
@IBDesignable
class UsernameTextField: UIView,UITextFieldDelegate,ValidationDelegate {
    ...
    func configure() {
        Bundle.main.loadNibNamed("UsernameTextField", owner: self, options: nil)
        self.addFullSizeSubview(view: self.contentView)
        
        self.sicilNoTextField.placeholder = "Username"
